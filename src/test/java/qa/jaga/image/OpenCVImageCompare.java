...
// Importing required classes
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File fileA
                    = new File(System.getProperty("user.dir") + "/src/main/resources/images/baseline/subscribe.png");
            File fileB
                    = new File(System.getProperty("user.dir") + "/src/main/resources/images/screenshot/subscribe.png");
